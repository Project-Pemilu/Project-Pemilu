  ...
  return (
    <div className="group flex flex-col items-center my-7">
      ...
      <div className="w-full max-w-xs h-40 px-4 py-8 flex flex-col items-center bg-gray-800 rounded-md mt-2" style={{ backgroundColor: theme.data[theme.currentTheme].cardBox }}>
        <p className="text-xl text-white uppercase text-center font-bold" style={{ color: theme.data[theme.currentTheme].cardText }}>
          {name}
        </p>
        <p className="text-sm text-gray-300 text-center my-2 px-5 h-24" style={{ color: theme.data[theme.currentTheme].cardText }}>
          {translations[currentLanguage].candidates[i]?.slogan}
        </p>
      </div>
      <div className="flex justify-center items-center h-16 mt-4">
        <button
          ...
          style={{ backgroundColor: theme.data[theme.currentTheme].buttonContainer, color: theme.data[theme.currentTheme].buttonText, border: theme.data[theme.currentTheme].buttonBorder }}
        >
          {translations[currentLanguage].voteButton}
        </button>
      </div>
    </div>
  );
